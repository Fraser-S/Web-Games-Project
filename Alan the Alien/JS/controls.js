...
function create()
{
    ...
    var shootTitle = this.game.add.sprite(game.world.centerX / 8, game.world.centerY * 1.3, "shoot", this);
    var shootButton = this.game.add.sprite(game.world.centerX * 1, game.world.centerY * 1.3, "shootButton", this);
}
